...
# sh -c "sudo anonymous start; ${SHELL:-bash}"
# sh -c "anonymous status; ${SHELL:-bash}"
# sh -c "sudo anonymous stop; ${SHELL:-bash}"
...
# List, separated by spaces, of destinations that you do not want to be routed through Tor
NON_TOR="192.168.1.0/24 172.16.0.0/12"
